...
public class GeneralExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException e, HttpHeaders headers, HttpStatusCode status, WebRequest request) {
        ...
        return handleExceptionInternalArgs(
                e,
                HttpHeaders.EMPTY,
                GeneralErrorCode.valueOf("_BAD_REQUEST"),
                request,
                errors);
    }
    ...
    public ResponseEntity<Object> exception(Exception e, WebRequest request) {
        ...
        return handleExceptionInternalFalse(
                e,
                GeneralErrorCode._INTERNAL_SERVER_ERROR,
                HttpHeaders.EMPTY,
                GeneralErrorCode._INTERNAL_SERVER_ERROR.getHttpStatus(),
                request,
                e.getMessage());
    }
    ...
    private ResponseEntity<Object> handleExceptionInternalFalse(Exception e, GeneralErrorCode errorCommonStatus,
